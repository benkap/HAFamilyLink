...
4. Add this URL:  
   ```
   https://github.com/benkap/HAFamilyLink
   ```
5. Click **Add** > **Close**
...
4. Add repository:  
   - **Repository**: `https://github.com/benkap/HAFamilyLink`
...
1. Download the [latest release](https://github.com/benkap/HAFamilyLink/releases) from GitHub
