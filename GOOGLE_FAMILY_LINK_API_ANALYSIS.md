...
| **Set recurring bedtime window** | POST | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [[null, null, null, [[day_code, [startH, startM], [endH, endM]]]], null, null, null, []], null, [1]]` | Updates the weekly bedtime window for one day. |
| **Toggle recurring bedtime day** | POST | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [[null, null, [[day_code, state]], null], null, null, null, []], null, [1]]` | `state`: 2=ON, 1=OFF for the weekday. |
| **Set recurring daily limit minutes** | POST | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [null, [[2, null, null, [[day_code, minutes]]]]], null, [1]]` | Updates the weekly daily limit minutes for one day. |
| **Toggle recurring daily limit day** | POST | `/kidsmanagement/v1/people/{childId}/timeLimit:update?$httpMethod=PUT` | `[null, childId, [null, [[2, null, [[day_code, state]], null]]], null, [1]]` | `state`: 2=ON, 1=OFF for the daily limit weekday. |
...
- **Schooltime schedule updates**: Write endpoint shape not yet verified.
